...
VC_CHECK_INTERVAL = 0.5  # ultra fast check
muted_users = set()
peer = None

# ================= APP ====================
app = Client("vcghost_ultra_v2", api_id=API_ID, api_hash=API_HASH, session_string=SESSION_STRING)

# ----------------- TIME SYNC ----------------
async def sync_time():
    try:
        await app.invoke(Ping(ping_id=123456789))
        print("⏱️ Time synced manually ✅")
...
async def main():
    global peer
    print("🚀 Starting Ultra V2 Ghost VC Bot...")
